...
CREATE TABLE `bought` (
  ...
  `exp_days` varchar(25) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `disconnect_uuid`
--

CREATE TABLE `disconnect_uuid` (
  `id` bigint(20) NOT NULL,
...
CREATE TABLE `package` (
  ...
  `quater_price` decimal(12,2) NOT NULL,
  `semiannual_price` decimal(12,2) NOT NULL,
...
--
-- Indexes for table `disconnect_uuid`
--
ALTER TABLE `disconnect_uuid`
  ADD PRIMARY KEY (`id`);
